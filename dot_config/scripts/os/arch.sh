...
# Essential
paru -S --noconfirm onedrive-abraunegg authy anki-bin google-chrome visual-studio-code-bin spotify-wayland bluetuith postman-bin etcher-bin scc pycharm-community-jre rustdesk-bin
exit
